...
function MovieCart(props) {
    ...
    let isExist = watchList.some(filmList => filmList["imdbID"] === filmData.imdbID);
  return (
    <>
        <div className="film-container" >
            ...
            {filmData.Poster !== "N/A" ? (
                ...
                <img src="https://www.omdbapi.com/src/poster.jpg"
                    className="movie-image"
                />
            )
            ...
            <div className="film-info">
                ...
                <div className="btn-container">
                    <button id="add-btn" onClick={() => addToWatchList(filmData)} disabled={isExist} ></button>
